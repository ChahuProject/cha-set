        ...
        Item {
            ...
            Column {
                ...
                Column {
                    spacing: 6
                    width: parent.width
                    Text { text: "API Secret Key (Masked with Copy):"; color: ThemeTokens.subduedText; font.pixelSize: 12 }
                    ChaSetReadOnlyInput {
                        width: parent.width
                        value: "cs_live_94817264810294827104"
                        masked: true
                ...
                Column {
                    spacing: 6
                    width: parent.width
                    Text { text: "GitHub Personal Access Token (Masked):"; color: ThemeTokens.subduedText; font.pixelSize: 12 }
                    ChaSetReadOnlyInput {
                        width: parent.width
