...
Rectangle {
    ...
    color: {
        ...
        if (root.variant === "ghost") {
            if (root.effectiveDown) return root.isDark ? Qt.rgba(0.18, 0.23, 0.32, 0.8) : Qt.rgba(0.95, 0.96, 0.97, 1.0)
            if (root.effectiveHovered) return root.isDark ? Qt.rgba(0.15, 0.2, 0.28, 1.0) : Qt.rgba(0.945, 0.961, 0.976, 1.0)
            return "transparent"
        }

        if (root.effectiveDown) {
            if (root.variant === "default") return Qt.rgba(0.29, 0.584, 0.902, 1.0)      // #4a95e6
            if (root.variant === "secondary") return root.isDark ? Qt.rgba(0.18, 0.23, 0.32, 1.0) : Qt.rgba(0.96, 0.973, 0.984, 1.0)
            if (root.variant === "outline") return root.isDark ? Qt.rgba(1, 1, 1, 0.18) : Qt.rgba(0, 0, 0, 0.12)
        ...
        if (root.effectiveHovered) {
            ...
            if (root.variant === "secondary") return root.isDark ? Qt.rgba(0.15, 0.2, 0.28, 1.0) : Qt.rgba(0.957, 0.969, 0.98, 1.0)
            if (root.variant === "outline") return root.isDark ? Qt.rgba(1, 1, 1, 0.12) : Qt.rgba(0, 0, 0, 0.08)
        ...
        if (root.variant === "default") {
            ...
            return root.isDark ? Qt.rgba(0.118, 0.161, 0.231, 1.0) : Qt.rgba(0.945, 0.961, 0.976, 1.0) // #f1f5f9
        } else if (root.variant === "destructive") {
            return root.isDark ? Qt.rgba(0.937, 0.267, 0.267, 0.2) : Qt.rgba(253.0 / 255.0, 236.0 / 255.0, 236.0 / 255.0, 1.0)
        } else if (root.variant === "outline") {
            return root.isDark ? Qt.rgba(1, 1, 1, 0.06) : Qt.rgba(0, 0, 0, 0.04)
        }
        return ThemeTokens.accent
    }
