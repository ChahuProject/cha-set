...
| [`scroll-area.md`](./scroll-area.md) | ScrollArea & ScrollBar specifications: zero-latency kinematics, auto-hide, stepper buttons, and desktop wheel handling | `packages/react/src/scroll-area/`, `qt/src/ChaSetScrollBar.qml`, `qt/src/ChaSetScrollView.qml` | `[Authoritative Specification]` |
